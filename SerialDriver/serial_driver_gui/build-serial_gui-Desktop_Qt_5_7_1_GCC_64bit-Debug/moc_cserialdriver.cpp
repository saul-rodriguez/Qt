...
#include "../../serial_driver/cserialdriver.h"
...
void CSerialDriver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (CSerialDriver::*_t)(const QByteArray & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CSerialDriver::RxAvailable)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject CSerialDriver::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CSerialDriver.data,
      qt_meta_data_CSerialDriver,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CSerialDriver::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CSerialDriver.stringdata0))
        return static_cast<void*>(const_cast< CSerialDriver*>(this));
