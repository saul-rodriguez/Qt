...
int QT_RCC_MANGLE_NAMESPACE(qInitResources_qmake_Shared_copy)();
int QT_RCC_MANGLE_NAMESPACE(qInitResources_qmake_Shared_copy)()
{
    int version = 3;
...
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_qmake_Shared_copy)();
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_qmake_Shared_copy)()
{
    int version = 3;
...
namespace {
   struct initializer {
       initializer() { QT_RCC_MANGLE_NAMESPACE(qInitResources_qmake_Shared_copy)(); }
       ~initializer() { QT_RCC_MANGLE_NAMESPACE(qCleanupResources_qmake_Shared_copy)(); }
   } dummy;
}
