...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_BluetoothBaseClass_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_BluetoothBaseClass_t qt_meta_stringdata_BluetoothBaseClass = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_BluetoothBaseClass[] = {
...
Q_CONSTINIT const QMetaObject BluetoothBaseClass::staticMetaObject = { {
    ...
    qt_meta_stringdata_BluetoothBaseClass.offsetsAndSizes,
    qt_meta_data_BluetoothBaseClass,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_BluetoothBaseClass_t,
        // property 'error'
