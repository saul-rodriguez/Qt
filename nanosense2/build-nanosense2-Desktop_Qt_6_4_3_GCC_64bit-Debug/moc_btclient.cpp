...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_BTClient_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_BTClient_t qt_meta_stringdata_BTClient = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_BTClient[] = {
...
Q_CONSTINIT const QMetaObject BTClient::staticMetaObject = { {
    ...
    qt_meta_stringdata_BTClient.offsetsAndSizes,
    qt_meta_data_BTClient,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_BTClient_t,
        // Q_OBJECT / Q_GADGET
