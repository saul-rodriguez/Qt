...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_sweep_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_sweep_t qt_meta_stringdata_sweep = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_sweep[] = {
...
Q_CONSTINIT const QMetaObject sweep::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_sweep.offsetsAndSizes,
    qt_meta_data_sweep,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_sweep_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<sweep, std::true_type>
    >,
    nullptr
} };
